...
func (h *UserHandler) Gets(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&input); err != nil {
		...
		input = domain.GetUsersRequest{}
	}

	resp, err := h.userUsecase.Gets(r.Context(), input)
	if err != nil {
		HandleError(w, err)
		return
	}
...
func (h *UserHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := h.userUsecase.Create(r.Context(), input)
	if err != nil {
		HandleError(w, err)
		return
	}
...
func (h *UserHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := h.userUsecase.Update(r.Context(), input)
	if err != nil {
		HandleError(w, err)
		return
	}
